...
face_classifier = cv2.CascadeClassifier(cv2.data.haarcascades + 'haarcascade_frontalface_default.xml') #E:\\cv\\cv_project\\data\data2\\face_detection11.h5

mask_detection = tf.keras.models.load_model("C:\\Users\\moham\\Desktop\\mask-detection\\models")
